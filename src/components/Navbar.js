...
export const Navbar = (props) => {
    const [outsideClick,setOutsideClick] = useState(props.click)
    ...
    return (
        <div className='container-fluid m-0 p-0 navbar-wrapper' onClick={clkHandler}>
                ...
                <div className='col-8 col-sm-8 col-md-9 col-lg-10 text-center d-flex flex-column justify-content-center'>
                    ...
                    <div className='row me-4'>
                        ...
                        <div className='col-3 col-md-2 col-lg-2 col-xl-1 position-relative d-flex flex-column align-items-center'>
                            <img id="dr" className='position-relative navbar-image' src={show1 ? notification1 : notification} onClick={notificationHandler}></img>
                            {show1 &&
